...
if (!isset($_SESSION['current_voyage'])) {
    echo "<p>Aucune information de voyage trouvée.</p>";
    exit;
}

$recap = $_SESSION['current_voyage'];
$prix_total = 0;
$nb_personnes = $recap['passagers']['adultes'] + $recap['passagers']['enfants'] + $recap['passagers']['bebes'];
?>
